        ...
        <ul class="nav nav-tabs mb-4">
            <li class="nav-item">
                <a class="nav-link {{ config('manta-cms.locale') == $locale ? 'active' : null }}" aria-current="page"
                    href="{{ route('manta.contact.update', ['input' => $item->translation()['org']->id]) }}">{{ config('manta-cms.locales')[config('manta-cms.locale')]['language'] }} <span
                ...
                @if ($key != config('manta-cms.locale'))
                    <li class="nav-item">
                        <a class="nav-link {{ $key == $locale ? 'active' : null }}"
                            href="{{ route('manta.contact.update', ['locale' => $key, 'input' => $item->id]) }}">{{ $value['language'] }}
